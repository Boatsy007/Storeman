(() => {
  ...
  uiStyle.textContent = `
    .service-grid-three{grid-template-columns:repeat(3,minmax(0,1fr))}.service-grid-three .service-title h3{font-size:18px}.service-grid-three .icon-box{font-family:"Archivo Black",sans-serif;font-size:11px;font-weight:900}
    ...
    .quote-notes{margin-top:12px}.quote-notes em,.photo-upload-title em,.estimate-field em{font-style:normal;color:#777;font-weight:600}.quote-notes textarea{width:100%;resize:vertical;min-height:76px;border:1px solid #d1d1d1;background:#fbfbfb;padding:10px 12px;font:600 12px/1.4 Inter,sans-serif;outline:none}.quote-notes textarea:focus{background:#fff;border-color:#111;box-shadow:0 0 0 2px rgba(255,224,0,.5)}
  ...
  function fillConfirmation(flow,payload) {
    ...
    const businessWrap=flow.querySelector('[data-confirm-business-wrap]'); if(businessWrap) businessWrap.hidden=!payload.business;
